      ...
      <View style={{ flex: 1, justifyContent: 'center' }}>
         <ImageBackground source={backgroundImg} style={styles.bk}>
            <View style={styles.ButtonContainer}>
               <TouchableOpacity
                  onPress={() => setCurrentContent('eyeshadows')}
               >
                  <Image style={styles.button1} source={eyeshadowsImg} />
               </TouchableOpacity>
               <TouchableOpacity
                  onPress={() => setCurrentContent('nightsaying')}
               >
                  <Image style={styles.button2} source={nightsayingImg} />
               </TouchableOpacity>
            </View>
            ...
            >
               <Image source={sumImg} style={styles.sumButton} />
            </TouchableOpacity>
         </ImageBackground>
      </View>
   )
